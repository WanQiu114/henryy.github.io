  ...
  return <section className="hero" id="home">
    ...
    <div className="hero-grid">
      <div className="hero-copy">
        ...
        <div className="hero-actions"><a className="button button-dark" href="#publications">Explore my research <span>↓</span></a><a className="text-link" href={`${import.meta.env.BASE_URL}assets/pdf/HeYang%20Yuan%20Resume.pdf`} target="_blank" rel="noreferrer">View CV <span>↗</span></a></div>
      </div>
